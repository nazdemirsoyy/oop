...
(string without white spaces), then the results of every task the competitor solved on the scale of 1..100 (integer), the competitor solved at least one task!
GRADE 3:get the competitor who got the max score before the first failing competitor (the score is the average
